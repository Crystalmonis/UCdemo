...
public class HomePageAdapter extends RecyclerView.Adapter {
    ...
    public class StripAdBannerViewHolder extends RecyclerView.ViewHolder {
        ...
        private void setStripAd(String resource, String color) {
            Glide.with(itemView.getContext()).load(resource).apply(new RequestOptions().placeholder(R.drawable.place_holder_big)).into(stripAdImage);
    ...
    public class HorizontalProductViewHolder extends RecyclerView.ViewHolder {
        ...
        private final Button horizontalLayoutViewAllButton;
        private final RecyclerView horizontalRecyclerView;

        public HorizontalProductViewHolder(@NonNull View itemView) {
            super(itemView);
            horizontalLayoutTitle = itemView.findViewById(R.id.horizontal_scroll_layout_title);
            horizontalLayoutViewAllButton = itemView.findViewById(R.id.horizontal_product_recycler_view_all_btn);
    ...
    public class GridProductViewHolder extends RecyclerView.ViewHolder {
        ...
        private void setGridProductLayout(List<HorizontalProductScrollModel> horizontalProductScrollModelList, String title, String color) {
            ...
            for (int x = 0; x < 4; x++) {
                ...
                Glide.with(itemView.getContext()).load(horizontalProductScrollModelList.get(x).getProductImage()).apply(new RequestOptions().placeholder(R.drawable.place_holder_big)).into(productImage);
